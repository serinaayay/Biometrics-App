...
export default function HomeScreen({ navigation }: Props) {
  ...
  const { regisData } = useRegis(); // Get email from registration context
  ...
  const handlePhoneNumberChange = (text: string) => {
    ...
    if (text === '' || text.toLowerCase() === 'n/a') {
      ...
      text = '09' + text.slice(2); // Ensure it starts with 09
  ...
  const handleNext = () => {
    ...
    const formData = {
      ...
      email: regisData.email1.trim(), // Use email from registration context
        ...
        <View style={styles.fieldContainer}>
          <View>
            ...
            <TextInput
              ...
              placeholderTextColor="#9E9A9A"
              style={[styles.inputFields, { backgroundColor: '#F5F5F5', color: '#666666' }]}
              value={regisData.email1} // Use email from registration context
              editable={false}
            />
